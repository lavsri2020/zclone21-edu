...
class Details extends React.Component {
    ...
    componentDidMount() {
        ...
        axios({
            url: ` https://gentle-plateau-37072.herokuapp.com/api/restaurant/${restaurant}`,
            method: 'GET',
    ...
    handleModal = (state, value) => {
        ...
        if (state == "menuItemsModalIsOpen" && value == true) {
            console.log(resId);
            axios({
                url:` https://gentle-plateau-37072.herokuapp.com/api/menuitems/${resId}`,
                   method: 'GET',
                headers: { 'Content-Type': 'application/json' }
            }).then(res => {
    ...
    getData = (data) => {
        return fetch(` https://gentle-plateau-37072.herokuapp.com/api/payment`, {
            method: "POST",
            headers: {
